...
У каждого значимого элемента должно быть прослеживаемое происхождение —
исходный документ/предложение/клауза, правило создания, стадия pipeline,
хэш конфига, ссылки на входы.
"""
